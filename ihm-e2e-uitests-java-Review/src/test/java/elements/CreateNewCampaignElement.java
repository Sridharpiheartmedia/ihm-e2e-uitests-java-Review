...
public class CreateNewCampaignElement {

    @FindBy(how = How.CSS, using = ".at-dashboard-no-proposal-create-new > .mat-button-wrapper")
    public static WebElement btnCreateProposal;
    ...
    @FindBy(how = How.CSS, using = ".mat-calendar-body-label")
    public static WebElement calendarMat;
